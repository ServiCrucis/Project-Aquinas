...
#define BYTE_ORDER_LO_TO_HI 0
#define BYTE_ORDER_HI_TO_LO 1
#define BYTE_ORDER_INVARIANT 2
#define BYTE_ORDER_UNKNOWN 3
...
#ifndef ARCH_DEFAULT_BYTE_ORDER
  #define ARCH_DEFAULT_BYTE_ORDER ARCH_BYTE_ORDER
#endif
...
// device m_context types should be twice the native qword size in bits
 ...
 * A `struct p_result` containing a m_context of type `char *`, a null-terminated string containing the platform name.
 */
char *p_get_platform();
 ...
 *
 *  The return type and arguments of this function m_context are non-sensical; you must cast the returned function m_context
 *  to the correct function m_context.
 *
 *  ## `char *module`
 ...
 * a m_context value representing the identifier of the function relative to the start of the module
 *
 * ## `return uintptr_t`
